...
export const moneySummaryTool: Tool = {
  ...
  description:
    ...
    "サブスクリプションの月額固定費（通貨別の合計・支払方法別の合計・契約ごとの明細・31日以内の支払予定）を含む。" +
    "契約ごとの明細には契約状況（自動更新中か解約予定か）と支払方法（どのカード・口座から落ちるか）が入る。" +
    "「いくら持っているか」「どの口座にいくらあるか」「保有銘柄は何か」に加えて、" +
    "「毎月の固定費はいくらか」「次の支払は何がいつあるか」「今月いくら残るか」" +
    "「解約予定のサブスクはどれか」「どのカードから毎月いくら落ちているか」を尋ねられたときに呼ぶ。" +
